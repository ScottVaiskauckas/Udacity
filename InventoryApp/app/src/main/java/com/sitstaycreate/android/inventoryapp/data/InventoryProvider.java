...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String productPrice = values.getAsString(InventoryEntry.COLUMN_PRODUCT_NAME);
        ...
        if (supplierName == null) {
            throw new IllegalArgumentException("You must enter the supplier's name");
        }

        String supplierPhone = values.getAsString(InventoryEntry.COLUMN_SUPPLIER_PHONE_NUMBER);
        if (supplierPhone == null) {
            throw new IllegalArgumentException("You must enter the supplier's phone number");
        }
